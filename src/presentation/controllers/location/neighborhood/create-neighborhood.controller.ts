...
import { CreateNeighborhoodUseCase } from '@root/domain/location/applications/use-cases/neighborhood/create-neighborhood.use-case'
import {
  CreateNeighborhoodBodySwaggerDto,
  CreateNeighborhoodResponseSwaggerDto,
  CreateNeighborhoodSwaggerDto,
} from '@root/presentation/swagger/location/docs/neighborhood/create-neighborhood.dto'
