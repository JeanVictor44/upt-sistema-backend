...
import { ListNeighborhoodUseCase } from '@root/domain/location/applications/use-cases/neighborhood/list-neighborhood.use-case'
import {
  ListNeighborhoodsResponseSwaggerDto,
  ListNeighborhoodsSwaggerDto,
} from '@root/presentation/swagger/location/docs/neighborhood/list-neighborhood-swagger.dto'
