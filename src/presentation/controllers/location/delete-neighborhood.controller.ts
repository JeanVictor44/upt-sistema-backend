...
import { DeleteNeighborhoodUseCase } from '@root/domain/location/applications/use-cases/delete-neighborhood.use-case'
import {
  DeleteNeighborhoodResponseSwaggerDto,
  DeleteNeighborhoodSwaggerDto,
} from '@root/presentation/swagger/location/docs/delete-neighborhood-swagger.dto'
