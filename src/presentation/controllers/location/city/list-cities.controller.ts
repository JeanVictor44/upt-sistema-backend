...
import { ListCitiesUseCase } from '@root/domain/location/applications/use-cases/city/list-cities.use-case'
import {
  ListCitiesResponseSwaggerDto,
  ListCitiesSwaggerDto,
} from '@root/presentation/swagger/location/docs/city/list-city-swagger'
