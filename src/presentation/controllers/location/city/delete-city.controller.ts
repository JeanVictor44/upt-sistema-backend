...
import { DeleteCityUseCase } from '@root/domain/location/applications/use-cases/city/delete-city-use-case'
import {
  DeleteCityResponseSwaggerDto,
  DeleteCitySwaggerDto,
} from '@root/presentation/swagger/location/docs/city/delete-city-swagger.dto'
