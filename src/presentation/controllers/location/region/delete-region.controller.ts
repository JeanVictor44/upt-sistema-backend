...
import { DeleteRegionUseCase } from '@root/domain/location/applications/use-cases/region/delete-region.use-case'
import {
  DeleteRegionResponseSwaggerDto,
  DeleteRegionSwaggerDto,
} from '@root/presentation/swagger/location/docs/region/delete-region-swagger.dto'
