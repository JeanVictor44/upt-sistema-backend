...
import { ListTeachingPlacesUseCase } from '@root/domain/location/applications/use-cases/list-teaching-places.use-case'
import {
  ListTeachingPlacesResponseSwaggerDto,
  ListTeachingPlaceSwaggerDto,
} from '@root/presentation/swagger/location/docs/list-teaching-place.swagger.dto'
